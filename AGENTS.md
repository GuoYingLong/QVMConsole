...
11. 不需要做编译验证
12. 测试环境的机器目录是在/opt/project/kvm_console 管理员账号admin admin123 普通用户 test Qw133133133133@ 一般我来测试就行，除非是修复bug。生产环境数据库是在/opt/kvm-console/data/kvm_console.db而测试环境是/opt/project/kvm-console/data/kvm_console.db
